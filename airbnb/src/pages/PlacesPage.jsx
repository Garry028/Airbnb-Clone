            ...
            {action === 'new' && (
                <form action="">
                    ...
                    <div className='flex gap-2'>
                        ...
                        <button className='bg-gray-200 grow rounded-2xl p-4' >Add&nbsp;Photo </button>
                    </div>
                    ...
                    <p className='text-gray-500 text-sm'>(House rules ,etc)</p><textarea></textarea>

                    <h2 className='text-2xl mt-4'>Check In & Out Times </h2>
                    <p className='text-gray-500 text-sm'> (Add check in & out times remember to have time for cleaning)</p>
